...
if (isset($_POST['Reserver'])) { 
    ...
    $_SESSION['departPro']=$_POST['depart'];
    $_SESSION['destinationPro']=$_POST['destination'];
    $_SESSION['passagerPro']=$_POST['passager'];
    $_SESSION['trajetPro']=$_POST['trajet'];
    $_SESSION['destinationRetourPro']=$_POST['destinationRetour'];
    $_SESSION['panierTrajet']=2;
}
else {
...
<?php
//MODULE MINI MAP
$Depart=Geolocat($_SESSION['departPro'], $KeyGoogleAPI);
$Destination=Geolocat($_SESSION['destinationPro'], $KeyGoogleAPI);

if ($_SESSION['trajetPro']==2) {
    $DepartRetour=Geolocat($_SESSION['destinationRetourPro'], $KeyGoogleAPI);
    $DestinationRetour=Geolocat($_SESSION['departPro'], $KeyGoogleAPI);
}
?>
<div id="map"></div>
