...
elseif ($Cnx_Client===false) {
  $Erreur="Veuillez vous connecter avant de continuer !";
   header('location:'.$Home.'/Panier/Identification/?erreur='.$Erreur);
}
?>
<!DOCTYPE HTML>
<html>
...
<?php require_once($_SERVER['DOCUMENT_ROOT']."/lib/article/vente/PanierValidation.inc.php"); ?>
