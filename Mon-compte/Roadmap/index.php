...
if ($Cnx_Chauffeur===false) {
  $Erreur="Vous devez être chauffeur pour accéder à cette page";
  header('location:'.$Home.'/Mon-compte/?erreur='.$Erreur);
}
?>
...
<?php require_once($_SERVER['DOCUMENT_ROOT']."/lib/article/compte/roadmap.inc.php"); ?>
