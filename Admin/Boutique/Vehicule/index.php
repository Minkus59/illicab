...
$Select=$cnx->prepare("SELECT * FROM ".$Prefix."neuro_Vehicule");
$Select->execute();
...
while ($Vehicule=$Select->fetch(PDO::FETCH_OBJ)) {
?>
   <tr>
   <td><?php echo $Vehicule->id; ?></td>
   <td><?php echo $Vehicule->libele; ?></td>
   <td><?php 
   echo '<a href="'.$Home.'/Admin/Boutique/Vehicule/Nouveau/?id='.$Vehicule->id.'"><img src="'.$Home.'/Admin/lib/img/modifier.png"></a>';
   echo '<a title="Supprimer" href="'.$Home.'/Admin/Boutique/Vehicule/supprimer.php?id='.$Vehicule->id.'"><img src="'.$Home.'/Admin/lib/img/supprimer.png"></a></td></tr>';
} ?>
</table>
