...
$Select=$cnx->prepare("SELECT * FROM ".$Prefix."neuro_Personne");
$Select->execute();
?>
...
while ($Passager=$Select->fetch(PDO::FETCH_OBJ)) {
?>
   <tr>
   <td><?php echo $Passager->quantite; ?></td>
   <td><?php echo $Passager->taux; ?></td>
   <td><?php 
   echo '<a href="'.$Home.'/Admin/Boutique/Taux/Nouveau/?id='.$Passager->id.'"><img src="'.$Home.'/Admin/lib/img/modifier.png"></a>';
   echo '<a title="Supprimer" href="'.$Home.'/Admin/Boutique/Taux/supprimer.php?id='.$Passager->id.'"><img src="'.$Home.'/Admin/lib/img/supprimer.png"></a></td></tr>';
} ?>
</table>
