...
if ((!empty($_GET['id']))&&(isset($_POST['oui']))) {
    ...
    $Update=$cnx->prepare("UPDATE ".$Prefix."neuro_Reclamation SET statue=1 WHERE id=:id");
    $Update->bindParam(':id', $Id, PDO::PARAM_INT);
    $Update->execute();

    header('Location:'.$Home.'/Admin/Boutique/Client/SAV/');
}
...
Etes-vous sur de vouloir réouvrir cette réclamation ? </p>
