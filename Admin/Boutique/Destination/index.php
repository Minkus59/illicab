...
$Select=$cnx->prepare("SELECT * FROM ".$Prefix."neuro_Destination");
$Select->execute();
...
?>
   ...
   <td><?php 
   echo '<a href="'.$Home.'/Admin/Boutique/Destination/Nouveau/?id='.$Destination->id.'"><img src="'.$Home.'/Admin/lib/img/modifier.png"></a>';
   echo '<a title="Supprimer" href="'.$Home.'/Admin/Boutique/Destination/supprimer.php?id='.$Destination->id.'"><img src="'.$Home.'/Admin/lib/img/supprimer.png"></a></td></tr>';
} ?>
</table>
