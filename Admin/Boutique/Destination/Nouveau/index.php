...
$Select=$cnx->prepare("SELECT * FROM ".$Prefix."neuro_Destination WHERE id=:id");
...
if (isset($_POST['Ajouter'])) {
    ...
    elseif(!preg_match("#[0-9.]#", $Prix)) {
        ...
        $InsertArticle=$cnx->prepare("INSERT INTO ".$Prefix."neuro_Destination (libele, prix) VALUES (:libele, :prix)");
        ...
        header("location:".$Home."/Admin/Boutique/Destination/?valid=".urlencode($Valid));
    }
}
...
if (isset($_POST['Modifier'])) {
    ...
    elseif(!preg_match("#[0-9.]#", $Prix)) {
        ...
        $UpdateArticle=$cnx->prepare("UPDATE ".$Prefix."neuro_Destination SET libele=:libele, prix=:prix WHERE id=:id");
