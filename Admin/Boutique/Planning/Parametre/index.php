...
<H1>Personnaliser la couleur</H1>
...
<?php
while ($Client=$SelectEmployer->fetch(PDO::FETCH_OBJ)) {
    ?>
    <TR bgcolor="<?php echo $Client->couleur; ?>">
        <td><?php echo $Client->nom; ?></td>
        <td><?php echo $Client->prenom; ?></td>
        <TD><?php echo '<a href="'.$Home.'/Admin/Boutique/Planning/Parametre/Couleur/?id='.$Client->id.'"><img src="'.$Home.'/Admin/lib/img/modifier.png"></a>'; ?></TD>
    </TR>
    <?php
}
?>
